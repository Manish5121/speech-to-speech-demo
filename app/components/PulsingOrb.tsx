  ...
  return (
    ...
    >
      {isClient ? (
        ...
        // Server-side fallback that matches the button structure
        <div className="w-[100px] h-[100px] rounded-full border-2 border-blue-500/30 flex items-center justify-center" />
      )}
